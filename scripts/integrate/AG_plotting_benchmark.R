...
# Misc --------------------------------------------------------------------
# Define order
latent_order = c('X_latent_2', 'scpoli_1000', 'scvi_1000', 'sysvi_1000', 'pca_1000')
...
per_variable <- vroom::vroom(
  here::here('islet_cartography_scrna/data/integrate/second_pass/files/benchmark_results_per_variable.csv'),
...
total <- vroom::vroom(
  here::here('islet_cartography_scrna/data/integrate/second_pass/files/benchmark_results_total.csv'),
  col_types = vroom::cols(
    latent = vroom::col_character(),
    metric = vroom::col_character(),
    score = vroom::col_double()
...
plot_per_variable <- per_variable |> 
  dplyr::mutate(latent = base::factor(latent, levels = rev(latent_order))) |> 
  ...
  ggplot2::scale_y_discrete(labels = c("X_latent_2" = "IC latent",
                                       "scpoli_1000" = "scPoli",
                                       "scvi_1000" = "scVI",
                                       "sysvi_1000" = "sysVI",
                                       "pca_1000" = "PCA")) +
...
pdf(
  file = here::here("islet_cartography_scrna/data/integrate/second_pass/plot/benchmark_results.pdf"),
  height = 2,
  width = 5
)
combined_plot
