...
file_dir   = sys.argv[4]
key_batch0 = sys.argv[5]  # batch_key or system
...
# Save model
# -------------------------
model_path = os.path.join(model_dir, f'sysvi_{n}_{key_save}')
...
df_path = os.path.join(file_dir, f"sysvi_{n}_{key_save}.csv")
