...
# Load --------------------------------------------------------------------
adata_obs <- vroom::vroom(here::here("islet_cartography_scrna/data/quality_control_per_cluster/first_pass/files/adata_obs.csv"))
...
pdf(
  file = here::here("islet_cartography_scrna/data/quality_control_per_cluster/first_pass/plot/module_scor_vs_doublet_per_cluster_leiden_10.pdf"),
  height = 2,
  width = 2.5
)
module_doublet
...
## QC plots ----------------------------------------------------------------
pdf(
  file = here::here("islet_cartography_scrna/data/quality_control_per_cluster/first_pass/plot/qc_plots_per_cluster_leiden_10.pdf"),
  height = 2,
  width = 2
)
adata_sum |> 
...
pdf(
  file = here::here("islet_cartography_scrna/data/quality_control_per_cluster/first_pass/plot/qc_plots_per_cluster_leiden_10_with_threshold.pdf"),
  height = 2,
  width = 2
)
...
pdf(
  file = here::here("islet_cartography_scrna/data/quality_control_per_cluster/first_pass/plot/qc_plots_per_cell_doublet_probability.pdf"),
  height = 2,
  width = 2
)
adata_obs |> 
...
pdf(
  file = here::here("islet_cartography_scrna/data/quality_control_per_cluster/first_pass/plot/qc_plots_per_cell_doublet_probability_threshold.pdf"),
  height = 2,
  width = 2
)
...
vroom::vroom_write(cells_keep, here::here("islet_cartography_scrna/data/quality_control_per_cluster/first_pass/files/barcodes_pass_qc.csv"),
                   delim = ",",
                   col_names = TRUE)
