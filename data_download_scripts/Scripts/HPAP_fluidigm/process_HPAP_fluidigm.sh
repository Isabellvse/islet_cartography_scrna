...
exec > >(tee -i /work/islet_cartography_scrna/data_download_scripts/Scripts/HPAP_fluidigm/output.log)
exec 2>&1

cd /work/islet_cartography_scrna/data_download_scripts/Scripts/HPAP_fluidigm/
