...
- `process_Mauvais_Jarvis.sh`: Download and align data with STARsolo
- `alignment_qc_Mauvais_Jarvis.sh`: Combine all alignment qaulity control parameters for all samples in a table
  
### Dataset at a glance

- `n samples`: 15 Non diabetic
